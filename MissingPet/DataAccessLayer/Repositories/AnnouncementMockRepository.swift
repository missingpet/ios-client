...
class AnnouncementMockRepository: AnnouncementRepositoryType {
    ...
    func getFeed(){
        let feed = [Announcement](
            arrayLiteral:
            Announcement(id: 1, user: "Пётр Петров", description: "Пропала собака по кличке Рекс. Нашедших ждёт вознаграждение! Просьба звонить по указанному в объявлении номеру телефона.", photo: "announcement-template-0", announcement_type: .lost, animal_type: .dog, place: "Some place", latitude: 0.1, longitude: 0.2, contact_phone_number: "+79995556677", created_at: "21 октября 2020, 15:34", updated_at: "21 октября 2020, 15:34"),
            ...
            Announcement(id: 3, user: "Александр Александров", description: "Пропала собка по адресу ул. Ерёменко 66/9.", photo: "announcement-template-2", announcement_type: .lost, animal_type: .dog, place: "г. Ростов-на-Дону, ул. Ерёменко 66/9.", latitude: 0.1, longitude: 0.2, contact_phone_number: "+79885647733", created_at: "21 октября 2020, 15:34", updated_at: "21 октября 2020, 15:34"),
            Announcement(id: 4, user: "Пётр Петров", description: "Пропала собака по кличке Рекс. Нашедших ждёт вознаграждение! Просьба звонить по указанному в объявлении номеру телефона.", photo: "announcement-template-3", announcement_type: .lost, animal_type: .dog, place: "Some place", latitude: 0.1, longitude: 0.2, contact_phone_number: "+79995556677", created_at: "21 октября 2020, 15:34", updated_at: "21 октября 2020, 15:34"),
            ...
            Announcement(id: 7, user: "Пётр Петров", description: "Пропала собака по кличке Мартин. Нашедших ждёт вознаграждение! Просьба звонить по указанному в объявлении номеру телефона.", photo: "announcement-template-2", announcement_type: .lost, animal_type: .dog, place: "Some place", latitude: 0.1, longitude: 0.2, contact_phone_number: "+79995556677", created_at: "21 октября 2020, 15:34", updated_at: "21 октября 2020, 15:34"),
    ...
    func getMyAnnoncements() {
        let myAnnouncements = [Announcement](
            arrayLiteral:
            Announcement(id: 16, user: "Алексей Алексеев", description: "Пропала собака по кличке Рекс. Нашедших ждёт вознаграждение! Просьба звонить по указанному в объявлении номеру телефона.", photo: "announcement-template-1", announcement_type: .lost, animal_type: .dog, place: "Some place", latitude: 0.1, longitude: 0.2, contact_phone_number: "+79995556677", created_at: "21 октября 2020, 15:34", updated_at: "21 октября 2020, 15:34"),
